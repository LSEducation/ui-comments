  ...
  function ($compile, commentsConfig, $controller, $exceptionHandler, $timeout) {
    return {
      ...
      link: function (scope, elem, attr, ctrls) {
        ...
        var children = false, compiled, sub = $compile('<div comments child-comments="true" ' + 'comment-data="comment.children" readonly="readonly"></div>'), transclude;
...
angular.module('template/comments/comments.html', []).run([
  '$templateCache',
  function ($templateCache) {
    $templateCache.put('template/comments/comments.html', '<div class="comments">\n' + '  <comment ng-repeat="comment in comments" comment-data="comment" readonly="readonly"></comment>\n' + '</div>\n' + '');
  }
]);